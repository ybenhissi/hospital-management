	...
	include('assets/inc/config.php');
		if(isset($_POST['add_pharmaceutical']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Produits pharmaceutiques ajoutés";
			}
			else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajouter des produits pharmaceutiques</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Créer un produit pharmaceutique</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Nom pharmaceutique</label>
                                                    <input type="text" required="required" name="phar_name" class="form-control" id="inputEmail4" >
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Quantité pharmaceutique (cartons)</label>
                                                    <input required="required" type="text" name="phar_qty" class="form-control"  id="inputPassword4">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Catégorie pharmaceutique</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputState" class="col-form-label">Vendeur pharmaceutique</label>
                                            ...
                                            <div class="form-group">
                                                    <label for="inputPassword4" class="col-form-label">Code-barres pharmaceutique(EAN-8)</label>
                                                    <?php 
                                                        $length = 10;    
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Description pharmaceutique</label>
                                                <textarea required="required" type="text" class="form-control" name="phar_desc" id="editor"></textarea>
                                            </div>

                                           <button type="submit" name="add_pharmaceutical" class="ladda-button btn btn-success" data-style="expand-right">Ajouter des produits pharmaceutiques</button>
