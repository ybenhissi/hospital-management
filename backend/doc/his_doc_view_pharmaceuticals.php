                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7" data-sort = "false">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Nom pharmaceutique</th>
                                                <th data-hide="phone">Code-barres pharmaceutique</th>
                                                <th data-hide="phone">Vendeur pharmaceutique</th>
                                                <th data-hide="phone">Catégorie pharmaceutique</th>
                                                <th data-hide="phone">Quantité pharmaceutique</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_doc_view_single_pharm.php?phar_bcode=<?php echo $row->phar_bcode;?>" class="badge badge-success"><i class="far fa-eye "></i> Afficher</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
