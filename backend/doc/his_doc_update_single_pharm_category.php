	...
	include('assets/inc/config.php');
		if(isset($_POST['update_pharmaceutical_category']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Catégorie pharmaceutique mise à jour ";
			}
			else {
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Gérer la catégorie pharmaceutique</li>
                                        </ol>
                                    </div>
                                        ...
                                        <form method="post">
                                            <div class="form-row" >
                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputEmail4" class="col-form-label">Nom de la catégorie pharmaceutique</label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputPassword4" class="col-form-label">Fournisseur de catégorie pharmaceutique</label>
                                            ...
                                            <div class="form-group">
                                                <label for="inputAddress" class="col-form-label">Description de la catégorie pharmaceutique</label>
                                           ...
                                           <button type="submit" name="update_pharmaceutical_category" class="ladda-button btn btn-danger" data-style="expand-right">Catégorie de mise à jour</button>
